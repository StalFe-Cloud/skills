...
description: "A meta-skill that extracts company-specific data knowledge from analysts and generates tailored data analysis skills."
---
...
eferences/skill-template.md`

**SQL Dialect Section**: See 
eferences/sql-dialects.md` and include the appropriate dialect notes.

**Reference File Template**: See 
eferences/domain-template.md`
...
eferences/[domain].md` using the domain template
