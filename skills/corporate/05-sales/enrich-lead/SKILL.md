---
name: enrich-lead
description: "Turn any identifier into a full contact dossier. The user provides identifying info via \"$ARGUMENTS\"."
---
...
1. **Save to Apollo** — Create this person as a contact via `mcp__claude_ai_Apollo_MCP__apollo_contacts_create` with 
un_dedupe: true`
