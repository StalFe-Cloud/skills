...
description: "This skill provides guidance for composing well-formatted, effective Slack messages."
---
...
- **Use 
eply_broadcast`** (also post to channel) only when the reply contains information everyone needs to see.
