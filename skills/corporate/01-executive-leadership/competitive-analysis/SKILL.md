...
description: "When source files (Excel/CSV) are provided:"
---
...
* If prompt says 
evenue: $43.98B (+18% YoY)` — display exactly that format
...
eferences/` folder. Use them as follows:
* **
eferences/schemas.md`** — Table templates for M&A transactions, scenario analysis, and slide structure. Reference when building financial tables or investment scenarios.
* **
eferences/frameworks.md`** — 2x2 matrix axis pairs by industry. Reference when choosing positioning visualization dimensions.
